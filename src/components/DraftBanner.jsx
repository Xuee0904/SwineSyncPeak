 ...
 * Supports a smooth slide-collapse animation when the draft is discarded.
 */
export default function DraftBanner({
  ...
  return (
    <div className="space-y-2 mb-4">
      ...
      {/* Draft Restoration Card — animates out on both restore and discard */}
      {hasDraft && (
        <div
          style={{
            ...
            overflow: 'hidden',
            transition: 'max-height 280ms cubic-bezier(0.4, 0, 0.2, 1), opacity 220ms ease-out, margin 280ms ease',
          }}
        >
          <div className="bg-gradient-to-br from-emerald-50/95 via-emerald-50/70 to-teal-50/80 border border-emerald-200/90 rounded-2xl p-4 shadow-xs">
